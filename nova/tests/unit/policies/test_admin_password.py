...
class AdminPasswordPolicyTest(base.BasePolicyTest):
    ...
    def setUp(self):
        ...
        # Check that admin and server owner is able to change the password
...
class AdminPasswordScopeTypePolicyTest(AdminPasswordPolicyTest):
    ...
    def setUp(self):
        ...
        # Check that system admin is able to change the password.
        self.admin_authorized_contexts = [
            self.system_admin_context]
        # Check that non-system or non-admin is not able to change the
        # password.
        self.admin_unauthorized_contexts = [
